...
def generate_custom_company_report_prompt(
    query_prompt, context, report_source: str, report_format, tone=None, total_words=1000, language: str = "english"
):
    with open('/home/anonymousa/Projects/wf-hackathon/gpt-researcher/backend/report_type/queries/used/new_rate_entities.txt', 'r') as file:
        research_query = file.read()
    
    #tone is used as an alias for company name
    with open('/home/anonymousa/Projects/wf-hackathon/gpt-researcher/backend/report_type/output/context.txt', 'a') as file:
        file.write(f"{tone}\n\n{context}\n\n\n")

    #return f'"{context}"\n\n{query_prompt}'

    return f"""Entity Name: {tone}
Search Results:  
{context} \n\n{research_query.format(company=tone)} 
"""
...
report_type_mapping = {
    ...
    ReportType.CustomCompanyReport.value: generate_custom_company_report_prompt
}
