...
async def generate_report(
    ...
    with open('/home/anonymousa/Projects/wf-hackathon/gpt-researcher/backend/report_type/output/agent_role_prompt.txt', 'a') as file:
        file.write(f"Agent Role Prompt:{agent_role_prompt}")
