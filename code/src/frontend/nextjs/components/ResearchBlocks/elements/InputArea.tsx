...
const InputArea: FC<TInputAreaProps> = ({
  ...
  return (
    <form
      className="mx-auto flex flex-col pt-2 pb-2 w-full items-center justify-center rounded-lg border bg-white px-3 shadow-[2px_2px_38px_0px_rgba(0,0,0,0.25),0px_-2px_4px_0px_rgba(0,0,0,0.25)_inset,1px_2px_4px_0px_rgba(0,0,0,0.25)_inset]"
      onSubmit={(e) => {
        e.preventDefault();
        if (reset) reset();
        handleSubmit(promptValue);
