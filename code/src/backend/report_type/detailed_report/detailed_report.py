...
class DetailedReport:
    ...
    async def _initial_research(self) -> None:
        ...
        print(f"Global context (init_res): {self.global_context}:::: Datatype:{type(self.global_context)}")
    ...
    async def _get_subtopic_report(self, subtopic: Dict) -> Dict[str, str]:
        ...
        print(f"Global context (after update): {self.global_context} :::: Datatype:{type(self.global_context)}")
